...
namespace BeatThat.Properties
{
    ...
    /// </summary>
    public class SetColor : MonoBehaviour, IDrive<HasColor>, IHasColorAsset
	{
		...
		public HasColor driven { get { return (m_hasColor != null)? m_hasColor: (m_hasColor = GetComponent<HasColor>()); } }
		...
		public ColorAsset colorAsset { get { return m_colorAsset; } }
		...
		public void OnColorAssetUpdated (ColorAsset colorAsset)
		{
			if (this.colorAsset != colorAsset) {
				return;
			}
			UpdateDisplay();
		}
